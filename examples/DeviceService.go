...
import (
	...
	goonvif "github.com/hiep2902/onvif"
	"github.com/hiep2902/onvif/device"
	sdk "github.com/hiep2902/onvif/sdk/device"
...
func main() {
	...
	if err != nil {
		...
		// You could use https://github.com/hiep2902/onvif/gosoap for pretty printing response
